...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/AccessrightsUserRole', 'model/Billing', 'model/Credential', 'model/Event', 'model/InlineResponse2002', 'model/InlineResponse2003', 'model/InlineResponse400', 'model/Invoice', 'model/Payment', 'model/Proforma', 'model/Project', 'model/ProjectCreate', 'model/ProjectLimit', 'model/ProjectPatchCredentialStoreId', 'model/ProjectPatchCredentialStorecertificateId', 'model/ProjectPostAccessrights', 'model/ProjectPostCredentialStore', 'model/ProjectPostCredentialStorecertificate', 'model/ProjectServices', 'model/ProjectUpdate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/AccessrightsUserRole'), require('../model/Billing'), require('../model/Credential'), require('../model/Event'), require('../model/InlineResponse2002'), require('../model/InlineResponse2003'), require('../model/InlineResponse400'), require('../model/Invoice'), require('../model/Payment'), require('../model/Proforma'), require('../model/Project'), require('../model/ProjectCreate'), require('../model/ProjectLimit'), require('../model/ProjectPatchCredentialStoreId'), require('../model/ProjectPatchCredentialStorecertificateId'), require('../model/ProjectPostAccessrights'), require('../model/ProjectPostCredentialStore'), require('../model/ProjectPostCredentialStorecertificate'), require('../model/ProjectServices'), require('../model/ProjectUpdate'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperoneClient) {
      root.HyperoneClient = {};
    }
    root.HyperoneClient.ProjectApi = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.AccessrightsUserRole, root.HyperoneClient.Billing, root.HyperoneClient.Credential, root.HyperoneClient.Event, root.HyperoneClient.InlineResponse2002, root.HyperoneClient.InlineResponse2003, root.HyperoneClient.InlineResponse400, root.HyperoneClient.Invoice, root.HyperoneClient.Payment, root.HyperoneClient.Proforma, root.HyperoneClient.Project, root.HyperoneClient.ProjectCreate, root.HyperoneClient.ProjectLimit, root.HyperoneClient.ProjectPatchCredentialStoreId, root.HyperoneClient.ProjectPatchCredentialStorecertificateId, root.HyperoneClient.ProjectPostAccessrights, root.HyperoneClient.ProjectPostCredentialStore, root.HyperoneClient.ProjectPostCredentialStorecertificate, root.HyperoneClient.ProjectServices, root.HyperoneClient.ProjectUpdate);
  }
}(this, function(ApiClient, AccessrightsUserRole, Billing, Credential, Event, InlineResponse2002, InlineResponse2003, InlineResponse400, Invoice, Payment, Proforma, Project, ProjectCreate, ProjectLimit, ProjectPatchCredentialStoreId, ProjectPatchCredentialStorecertificateId, ProjectPostAccessrights, ProjectPostCredentialStore, ProjectPostCredentialStorecertificate, ProjectServices, ProjectUpdate) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.projectCreateWithHttpInfo = function(projectCreate, opts) {
      opts = opts || {};
     ...
     */
    this.projectCreate = function(projectCreate, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Project} and HTTP response
     */
    this.projectDeleteCredentialStoreIdWithHttpInfo = function(projectId, id) {
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Project}
     */
    this.projectDeleteCredentialStoreId = function(projectId, id) {
     ...
     */
    this.projectGetCredentialStoreIdWithHttpInfo = function(projectId, id) {
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectGetCredentialStoreId = function(projectId, id) {
     ...
     */
    this.projectGetLimitWithHttpInfo = function(projectId) {
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectGetLimit = function(projectId) {
     ...
     */
    this.projectListBillingWithHttpInfo = function(projectId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectListBilling = function(projectId, opts) {
     ...
     */
    this.projectListCredentialStoreWithHttpInfo = function(projectId) {
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectListCredentialStore = function(projectId) {
     ...
     */
    this.projectListInvoiceWithHttpInfo = function(projectId) {
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectListInvoice = function(projectId) {
     ...
     */
    this.projectListPaymentWithHttpInfo = function(projectId) {
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectListPayment = function(projectId) {
     ...
     */
    this.projectListProformaWithHttpInfo = function(projectId) {
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectListProforma = function(projectId) {
     ...
     */
    this.projectListQueueWithHttpInfo = function(projectId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectListQueue = function(projectId, opts) {
     ...
     */
    this.projectListStatsWithHttpInfo = function(projectId) {
      var postBody = null;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     */
    this.projectListStats = function(projectId) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Credential} and HTTP response
     */
    this.projectPatchCredentialStoreIdWithHttpInfo = function(projectId, id, projectPatchCredentialStoreId) {
      var postBody = projectPatchCredentialStoreId;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Credential}
     */
    this.projectPatchCredentialStoreId = function(projectId, id, projectPatchCredentialStoreId) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Credential} and HTTP response
     */
    this.projectPostCredentialStoreWithHttpInfo = function(projectId, projectPostCredentialStore) {
      var postBody = projectPostCredentialStore;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Credential}
     */
    this.projectPostCredentialStore = function(projectId, projectPostCredentialStore) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object.<String, {String: String}>} and HTTP response
     */
    this.projectPutTagWithHttpInfo = function(projectId, requestBody) {
      var postBody = requestBody;
      // verify the required parameter 'projectId' is set
      if (projectId === undefined || projectId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object.<String, {String: String}>}
     */
    this.projectPutTag = function(projectId, requestBody) {
