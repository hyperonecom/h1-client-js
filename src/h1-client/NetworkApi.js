...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Event', 'model/InlineResponse400', 'model/Ip', 'model/Network', 'model/NetworkActionFirewallAdd', 'model/NetworkCreate', 'model/NetworkPostAccessrights', 'model/NetworkPostIp', 'model/NetworkServices', 'model/NetworkUpdate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/Event'), require('../model/InlineResponse400'), require('../model/Ip'), require('../model/Network'), require('../model/NetworkActionFirewallAdd'), require('../model/NetworkCreate'), require('../model/NetworkPostAccessrights'), require('../model/NetworkPostIp'), require('../model/NetworkServices'), require('../model/NetworkUpdate'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperoneClient) {
      root.HyperoneClient = {};
    }
    root.HyperoneClient.NetworkApi = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Event, root.HyperoneClient.InlineResponse400, root.HyperoneClient.Ip, root.HyperoneClient.Network, root.HyperoneClient.NetworkActionFirewallAdd, root.HyperoneClient.NetworkCreate, root.HyperoneClient.NetworkPostAccessrights, root.HyperoneClient.NetworkPostIp, root.HyperoneClient.NetworkServices, root.HyperoneClient.NetworkUpdate);
  }
}(this, function(ApiClient, Event, InlineResponse400, Ip, Network, NetworkActionFirewallAdd, NetworkCreate, NetworkPostAccessrights, NetworkPostIp, NetworkServices, NetworkUpdate) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     */
    this.networkActionFirewallAddWithHttpInfo = function(networkId, networkActionFirewallAdd, opts) {
      opts = opts || {};
      var postBody = networkActionFirewallAdd;
     ...
     */
    this.networkActionFirewallAdd = function(networkId, networkActionFirewallAdd, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Network} and HTTP response
     */
    this.networkActionFirewallRemoveWithHttpInfo = function(networkId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Network}
     */
    this.networkActionFirewallRemove = function(networkId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Network} and HTTP response
     */
    this.networkCreateWithHttpInfo = function(networkCreate, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Network}
     */
    this.networkCreate = function(networkCreate, opts) {
     ...
     */
    this.networkListQueueWithHttpInfo = function(networkId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
     ...
     */
    this.networkListQueue = function(networkId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object.<String, {String: String}>} and HTTP response
     */
    this.networkPutTagWithHttpInfo = function(networkId, requestBody) {
      var postBody = requestBody;
      // verify the required parameter 'networkId' is set
      if (networkId === undefined || networkId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object.<String, {String: String}>}
     */
    this.networkPutTag = function(networkId, requestBody) {
