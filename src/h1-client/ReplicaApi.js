...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyperoneClient.ReplicaApi = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Event, root.HyperoneClient.InlineResponse400, root.HyperoneClient.Replica, root.HyperoneClient.ReplicaActionImage, root.HyperoneClient.ReplicaCreate, root.HyperoneClient.ReplicaPostAccessrights, root.HyperoneClient.ReplicaServices);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.replicaActionImageWithHttpInfo = function(replicaId, replicaActionImage, opts) {
      opts = opts || {};
     ...
     */
    this.replicaActionImage = function(replicaId, replicaActionImage, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Replica} and HTTP response
     */
    this.replicaCreateWithHttpInfo = function(replicaCreate, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Replica}
     */
    this.replicaCreate = function(replicaCreate, opts) {
     ...
     */
    this.replicaListQueueWithHttpInfo = function(replicaId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'replicaId' is set
      if (replicaId === undefined || replicaId === null) {
     ...
     */
    this.replicaListQueue = function(replicaId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object.<String, {String: String}>}
     */
    this.replicaPatchTag = function(replicaId, requestBody) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object.<String, {String: String}>} and HTTP response
     */
    this.replicaPutTagWithHttpInfo = function(replicaId, requestBody) {
      var postBody = requestBody;
      // verify the required parameter 'replicaId' is set
      if (replicaId === undefined || replicaId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object.<String, {String: String}>}
     */
    this.replicaPutTag = function(replicaId, requestBody) {
