...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyperoneClient.VolumeApi = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Event, root.HyperoneClient.InlineResponse400, root.HyperoneClient.Volume, root.HyperoneClient.VolumeCreate, root.HyperoneClient.VolumePostAccessrights, root.HyperoneClient.VolumeServices, root.HyperoneClient.VolumeUpdate);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.volumeCreateWithHttpInfo = function(volumeCreate, opts) {
      opts = opts || {};
     ...
     */
    this.volumeCreate = function(volumeCreate, opts) {
     ...
     */
    this.volumeListQueueWithHttpInfo = function(volumeId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
     ...
     */
    this.volumeListQueue = function(volumeId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object.<String, {String: String}>} and HTTP response
     */
    this.volumePutTagWithHttpInfo = function(volumeId, requestBody) {
      var postBody = requestBody;
      // verify the required parameter 'volumeId' is set
      if (volumeId === undefined || volumeId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object.<String, {String: String}>}
     */
    this.volumePutTag = function(volumeId, requestBody) {
