...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyperoneClient.IpApi = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Event, root.HyperoneClient.InlineResponse400, root.HyperoneClient.Ip, root.HyperoneClient.IpActionAssociate, root.HyperoneClient.IpActionTransfer, root.HyperoneClient.IpCreate, root.HyperoneClient.IpPostAccessrights, root.HyperoneClient.IpServices, root.HyperoneClient.IpUpdate);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.ipActionAllocateWithHttpInfo = function(ipId, opts) {
      opts = opts || {};
      var postBody = null;
     ...
     */
    this.ipActionAllocate = function(ipId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Ip} and HTTP response
     */
    this.ipActionAssociateWithHttpInfo = function(ipId, ipActionAssociate, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Ip}
     */
    this.ipActionAssociate = function(ipId, ipActionAssociate, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Ip} and HTTP response
     */
    this.ipActionDisassociateWithHttpInfo = function(ipId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'ipId' is set
      if (ipId === undefined || ipId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Ip}
     */
    this.ipActionDisassociate = function(ipId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Ip} and HTTP response
     */
    this.ipActionTransferWithHttpInfo = function(ipId, ipActionTransfer, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Ip}
     */
    this.ipActionTransfer = function(ipId, ipActionTransfer, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Ip} and HTTP response
     */
    this.ipCreateWithHttpInfo = function(ipCreate, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Ip}
     */
    this.ipCreate = function(ipCreate, opts) {
     ...
     */
    this.ipListQueueWithHttpInfo = function(ipId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'ipId' is set
      if (ipId === undefined || ipId === null) {
     ...
     */
    this.ipListQueue = function(ipId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object.<String, {String: String}>} and HTTP response
     */
    this.ipPutTagWithHttpInfo = function(ipId, requestBody) {
      var postBody = requestBody;
      // verify the required parameter 'ipId' is set
      if (ipId === undefined || ipId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object.<String, {String: String}>}
     */
    this.ipPutTag = function(ipId, requestBody) {
