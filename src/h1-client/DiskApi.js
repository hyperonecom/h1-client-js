...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyperoneClient.DiskApi = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Disk, root.HyperoneClient.DiskActionClone, root.HyperoneClient.DiskActionResize, root.HyperoneClient.DiskActionTransfer, root.HyperoneClient.DiskCreate, root.HyperoneClient.DiskPostAccessrights, root.HyperoneClient.DiskServices, root.HyperoneClient.DiskUpdate, root.HyperoneClient.Event, root.HyperoneClient.InlineResponse400);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.diskActionCloneWithHttpInfo = function(diskId, diskActionClone, opts) {
      opts = opts || {};
     ...
     */
    this.diskActionClone = function(diskId, diskActionClone, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Disk} and HTTP response
     */
    this.diskActionResizeWithHttpInfo = function(diskId, diskActionResize, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Disk}
     */
    this.diskActionResize = function(diskId, diskActionResize, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Disk} and HTTP response
     */
    this.diskActionTransferWithHttpInfo = function(diskId, diskActionTransfer, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Disk}
     */
    this.diskActionTransfer = function(diskId, diskActionTransfer, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Disk} and HTTP response
     */
    this.diskCreateWithHttpInfo = function(diskCreate, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Disk}
     */
    this.diskCreate = function(diskCreate, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing HTTP response
     */
    this.diskGetDownloadWithHttpInfo = function(diskId) {
      var postBody = null;
      // verify the required parameter 'diskId' is set
      if (diskId === undefined || diskId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}
     */
    this.diskGetDownload = function(diskId) {
     ...
     */
    this.diskListQueueWithHttpInfo = function(diskId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'diskId' is set
      if (diskId === undefined || diskId === null) {
     ...
     */
    this.diskListQueue = function(diskId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object.<String, {String: String}>} and HTTP response
     */
    this.diskPutTagWithHttpInfo = function(diskId, requestBody) {
      var postBody = requestBody;
      // verify the required parameter 'diskId' is set
      if (diskId === undefined || diskId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object.<String, {String: String}>}
     */
    this.diskPutTag = function(diskId, requestBody) {
