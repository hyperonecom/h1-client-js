...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyperoneClient.IsoApi = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Event, root.HyperoneClient.InlineResponse400, root.HyperoneClient.Iso, root.HyperoneClient.IsoActionTransfer, root.HyperoneClient.IsoCreate, root.HyperoneClient.IsoPostAccessrights, root.HyperoneClient.IsoServices, root.HyperoneClient.IsoUpdate);
  }
  ...
  var exports = function(apiClient) {
     ...
     */
    this.isoActionTransferWithHttpInfo = function(isoId, isoActionTransfer, opts) {
      opts = opts || {};
     ...
     */
    this.isoActionTransfer = function(isoId, isoActionTransfer, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Iso} and HTTP response
     */
    this.isoCreateWithHttpInfo = function(isoCreate, opts) {
      opts = opts || {};
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Iso}
     */
    this.isoCreate = function(isoCreate, opts) {
     ...
     */
    this.isoListQueueWithHttpInfo = function(isoId, opts) {
      opts = opts || {};
      var postBody = null;
      // verify the required parameter 'isoId' is set
      if (isoId === undefined || isoId === null) {
     ...
     */
    this.isoListQueue = function(isoId, opts) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link Object.<String, {String: String}>} and HTTP response
     */
    this.isoPutTagWithHttpInfo = function(isoId, requestBody) {
      var postBody = requestBody;
      // verify the required parameter 'isoId' is set
      if (isoId === undefined || isoId === null) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link Object.<String, {String: String}>}
     */
    this.isoPutTag = function(isoId, requestBody) {
