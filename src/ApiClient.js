...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyperoneClient.ApiClient = factory(root.superagent, root.querystring);
  }
  ...
  var exports = function() {
     ...
     * @type {String}
     * @default https://api.hyperone.com/v1
     */
    this.basePath = 'https://api.hyperone.com/v1'.replace(/\/+$/, '');
