...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/CredentialCertificate', 'model/CredentialPassword', 'model/Event', 'model/InlineResponse400', 'model/Website', 'model/WebsiteActionUpdateDomain', 'model/WebsiteCreate', 'model/WebsitePatchCredentialcertificateId', 'model/WebsitePatchCredentialpasswordId', 'model/WebsitePostAccessrights', 'model/WebsitePostCredentialcertificate', 'model/WebsitePostCredentialpassword', 'model/WebsiteServices', 'model/WebsiteUpdate'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('../model/CredentialCertificate'), require('../model/CredentialPassword'), require('../model/Event'), require('../model/InlineResponse400'), require('../model/Website'), require('../model/WebsiteActionUpdateDomain'), require('../model/WebsiteCreate'), require('../model/WebsitePatchCredentialcertificateId'), require('../model/WebsitePatchCredentialpasswordId'), require('../model/WebsitePostAccessrights'), require('../model/WebsitePostCredentialcertificate'), require('../model/WebsitePostCredentialpassword'), require('../model/WebsiteServices'), require('../model/WebsiteUpdate'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperOneApi) {
      root.HyperOneApi = {};
    }
    root.HyperOneApi.WebsiteApi = factory(root.HyperOneApi.ApiClient, root.HyperOneApi.CredentialCertificate, root.HyperOneApi.CredentialPassword, root.HyperOneApi.Event, root.HyperOneApi.InlineResponse400, root.HyperOneApi.Website, root.HyperOneApi.WebsiteActionUpdateDomain, root.HyperOneApi.WebsiteCreate, root.HyperOneApi.WebsitePatchCredentialcertificateId, root.HyperOneApi.WebsitePatchCredentialpasswordId, root.HyperOneApi.WebsitePostAccessrights, root.HyperOneApi.WebsitePostCredentialcertificate, root.HyperOneApi.WebsitePostCredentialpassword, root.HyperOneApi.WebsiteServices, root.HyperOneApi.WebsiteUpdate);
  }
}(this, function(ApiClient, CredentialCertificate, CredentialPassword, Event, InlineResponse400, Website, WebsiteActionUpdateDomain, WebsiteCreate, WebsitePatchCredentialcertificateId, WebsitePatchCredentialpasswordId, WebsitePostAccessrights, WebsitePostCredentialcertificate, WebsitePostCredentialpassword, WebsiteServices, WebsiteUpdate) {
  'use strict';
  ...
  var exports = function(apiClient) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with an object containing data of type {@link module:model/Website} and HTTP response
     */
    this.websiteActionUpdateDomainWithHttpInfo = function(websiteId, websiteActionUpdateDomain) {
     ...
     * @return {Promise} a {@link https://www.promisejs.org/|Promise}, with data of type {@link module:model/Website}
     */
    this.websiteActionUpdateDomain = function(websiteId, websiteActionUpdateDomain) {
      return this.websiteActionUpdateDomainWithHttpInfo(websiteId, websiteActionUpdateDomain)
        .then(function(response_and_data) {
          return response_and_data.data;
        });
    }
