 ...
 * @version 0.0.2
 */
class LogArchivePostCredentialcertificate {
    /**
    ...
    constructor() { 
        ...
        LogArchivePostCredentialcertificate.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new LogArchivePostCredentialcertificate();
 ...
 * @member {String} name
 */
LogArchivePostCredentialcertificate.prototype['name'] = undefined;

/**
 * @member {String} type
 */
LogArchivePostCredentialcertificate.prototype['type'] = undefined;

/**
 * @member {String} value
 */
LogArchivePostCredentialcertificate.prototype['value'] = undefined;
...
export default LogArchivePostCredentialcertificate;
