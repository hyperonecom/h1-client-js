...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Event', 'model/NetgwPrimaryIPAssociated', 'model/NetgwPrimaryIPMac', 'model/ProjectServices'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Event'), require('./NetgwPrimaryIPAssociated'), require('./NetgwPrimaryIPMac'), require('./ProjectServices'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperOneApi) {
      root.HyperOneApi = {};
    }
    root.HyperOneApi.Ip = factory(root.HyperOneApi.ApiClient, root.HyperOneApi.Event, root.HyperOneApi.NetgwPrimaryIPAssociated, root.HyperOneApi.NetgwPrimaryIPMac, root.HyperOneApi.ProjectServices);
  }
}(this, function(ApiClient, Event, NetgwPrimaryIPAssociated, NetgwPrimaryIPMac, ProjectServices) {
  'use strict';
