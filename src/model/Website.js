...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Event', 'model/ProjectServices', 'model/WebsiteEnv'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Event'), require('./ProjectServices'), require('./WebsiteEnv'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperoneClient) {
      root.HyperoneClient = {};
    }
    root.HyperoneClient.Website = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Event, root.HyperoneClient.ProjectServices, root.HyperoneClient.WebsiteEnv);
  }
}(this, function(ApiClient, Event, ProjectServices, WebsiteEnv) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('env')) {
        obj['env'] = ApiClient.convertToType(data['env'], [WebsiteEnv]);
      }
  ...
  /**
   * @member {Array.<module:model/WebsiteEnv>} env
   */
