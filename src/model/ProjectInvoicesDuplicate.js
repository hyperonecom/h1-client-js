 ...
 * @version 0.0.2
 */
class ProjectInvoicesDuplicate {
    /**
    ...
    constructor() { 
        ...
        ProjectInvoicesDuplicate.initialize(this);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectInvoicesDuplicate();
 ...
 */
ProjectInvoicesDuplicate.prototype['createdOn'] = undefined;

/**
 * @member {String} _id
 */
ProjectInvoicesDuplicate.prototype['_id'] = undefined;
...
export default ProjectInvoicesDuplicate;
