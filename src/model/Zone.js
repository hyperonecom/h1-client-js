...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Event', 'model/ProjectServices', 'model/ZoneRecordset', 'model/ZoneRrsets'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Event'), require('./ProjectServices'), require('./ZoneRecordset'), require('./ZoneRrsets'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperoneClient) {
      root.HyperoneClient = {};
    }
    root.HyperoneClient.Zone = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Event, root.HyperoneClient.ProjectServices, root.HyperoneClient.ZoneRecordset, root.HyperoneClient.ZoneRrsets);
  }
}(this, function(ApiClient, Event, ProjectServices, ZoneRecordset, ZoneRrsets) {
  'use strict';
   ...
   */
  exports.prototype['rrsets'] = undefined;
  /**
   ...
   */
  exports.prototype['recordset'] = undefined;
  /**
   * @member {Array.<String>} nameserver
   */
  exports.prototype['nameserver'] = undefined;
  /**
   * @member {String} fqdn
   */
