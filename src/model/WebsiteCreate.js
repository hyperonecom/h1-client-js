...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/WebsiteCreateCredential', 'model/WebsiteCreateEnv', 'model/WebsiteCreateSource'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./WebsiteCreateCredential'), require('./WebsiteCreateEnv'), require('./WebsiteCreateSource'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperoneClient) {
      root.HyperoneClient = {};
    }
    root.HyperoneClient.WebsiteCreate = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.WebsiteCreateCredential, root.HyperoneClient.WebsiteCreateEnv, root.HyperoneClient.WebsiteCreateSource);
  }
}(this, function(ApiClient, WebsiteCreateCredential, WebsiteCreateEnv, WebsiteCreateSource) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('env')) {
        obj['env'] = ApiClient.convertToType(data['env'], [WebsiteCreateEnv]);
      }
  ...
  /**
   * @member {Array.<module:model/WebsiteCreateEnv>} env
   */
