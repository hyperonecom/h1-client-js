...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Event', 'model/NetgwNetwork', 'model/NetgwPrimaryIP', 'model/NetgwVpn', 'model/ProjectServices'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Event'), require('./NetgwNetwork'), require('./NetgwPrimaryIP'), require('./NetgwVpn'), require('./ProjectServices'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperOneApi) {
      root.HyperOneApi = {};
    }
    root.HyperOneApi.Netgw = factory(root.HyperOneApi.ApiClient, root.HyperOneApi.Event, root.HyperOneApi.NetgwNetwork, root.HyperOneApi.NetgwPrimaryIP, root.HyperOneApi.NetgwVpn, root.HyperOneApi.ProjectServices);
  }
}(this, function(ApiClient, Event, NetgwNetwork, NetgwPrimaryIP, NetgwVpn, ProjectServices) {
  'use strict';
