...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ContainerServices', 'model/Event', 'model/NetgwNetwork', 'model/NetgwPrimaryIP', 'model/NetgwVpn'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ContainerServices'), require('./Event'), require('./NetgwNetwork'), require('./NetgwPrimaryIP'), require('./NetgwVpn'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperOneApi) {
      root.HyperOneApi = {};
    }
    root.HyperOneApi.Netgw = factory(root.HyperOneApi.ApiClient, root.HyperOneApi.ContainerServices, root.HyperOneApi.Event, root.HyperOneApi.NetgwNetwork, root.HyperOneApi.NetgwPrimaryIP, root.HyperOneApi.NetgwVpn);
  }
}(this, function(ApiClient, ContainerServices, Event, NetgwNetwork, NetgwPrimaryIP, NetgwVpn) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('primaryIP')) {
        obj['primaryIP'] = NetgwPrimaryIP.constructFromObject(data['primaryIP']);
      }
      if (data.hasOwnProperty('network')) {
        obj['network'] = NetgwNetwork.constructFromObject(data['network']);
      }
      if (data.hasOwnProperty('vpn')) {
        obj['vpn'] = NetgwVpn.constructFromObject(data['vpn']);
      }
    }
    return obj;
  }
  ...
  /**
   * @member {module:model/NetgwPrimaryIP} primaryIP
   */
  exports.prototype['primaryIP'] = undefined;
  /**
   * @member {module:model/NetgwNetwork} network
   */
  exports.prototype['network'] = undefined;
  /**
   * @member {module:model/NetgwVpn} vpn
   */
  exports.prototype['vpn'] = undefined;
