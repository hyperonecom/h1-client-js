...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/UserCredential', 'model/UserLimit', 'model/UserNetworkAcl', 'model/UserPasswordReset', 'model/UserServices'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./UserCredential'), require('./UserLimit'), require('./UserNetworkAcl'), require('./UserPasswordReset'), require('./UserServices'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperoneClient) {
      root.HyperoneClient = {};
    }
    root.HyperoneClient.User = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.UserCredential, root.HyperoneClient.UserLimit, root.HyperoneClient.UserNetworkAcl, root.HyperoneClient.UserPasswordReset, root.HyperoneClient.UserServices);
  }
}(this, function(ApiClient, UserCredential, UserLimit, UserNetworkAcl, UserPasswordReset, UserServices) {
  'use strict';
