 ...
 * @version 0.0.3
 */
class AgentPostCredentialcertificate {
    /**
    ...
    constructor(name, type, value) { 
        ...
        AgentPostCredentialcertificate.initialize(this, name, type, value);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new AgentPostCredentialcertificate();
 ...
 * @member {String} name
 */
AgentPostCredentialcertificate.prototype['name'] = undefined;

/**
 * @member {String} type
 */
AgentPostCredentialcertificate.prototype['type'] = undefined;

/**
 * @member {String} value
 */
AgentPostCredentialcertificate.prototype['value'] = undefined;

/**
 * @member {String} token
 */
AgentPostCredentialcertificate.prototype['token'] = undefined;
...
export default AgentPostCredentialcertificate;
