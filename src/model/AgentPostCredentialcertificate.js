...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyperOneApi.AgentPostCredentialcertificate = factory(root.HyperOneApi.ApiClient);
  }
   ...
   * @class
   * @param name {String} 
   * @param type {module:model/AgentPostCredentialcertificate.TypeEnum} 
   * @param value {String} 
   */
  ...
  /**
   * @member {module:model/AgentPostCredentialcertificate.TypeEnum} type
   */
