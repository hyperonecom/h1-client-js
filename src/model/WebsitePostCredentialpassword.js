 ...
 * @version 0.0.3
 */
class WebsitePostCredentialpassword {
    /**
    ...
    constructor(name, type, value) { 
        ...
        WebsitePostCredentialpassword.initialize(this, name, type, value);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new WebsitePostCredentialpassword();
 ...
 * @member {String} name
 */
WebsitePostCredentialpassword.prototype['name'] = undefined;

/**
 * @member {String} type
 */
WebsitePostCredentialpassword.prototype['type'] = undefined;

/**
 * @member {String} value
 */
WebsitePostCredentialpassword.prototype['value'] = undefined;

/**
 * @member {String} token
 */
WebsitePostCredentialpassword.prototype['token'] = undefined;
...
export default WebsitePostCredentialpassword;
