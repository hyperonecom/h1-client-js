...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/ProjectLimitAgent', 'model/ProjectLimitContainer', 'model/ProjectLimitDisk', 'model/ProjectLimitNetwork', 'model/ProjectLimitPolicy', 'model/ProjectLimitRegistry', 'model/ProjectLimitReservation', 'model/ProjectLimitRole', 'model/ProjectLimitSa', 'model/ProjectLimitSnapshot', 'model/ProjectLimitVault', 'model/ProjectLimitVm', 'model/ProjectLimitVolume'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./ProjectLimitAgent'), require('./ProjectLimitContainer'), require('./ProjectLimitDisk'), require('./ProjectLimitNetwork'), require('./ProjectLimitPolicy'), require('./ProjectLimitRegistry'), require('./ProjectLimitReservation'), require('./ProjectLimitRole'), require('./ProjectLimitSa'), require('./ProjectLimitSnapshot'), require('./ProjectLimitVault'), require('./ProjectLimitVm'), require('./ProjectLimitVolume'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperoneClient) {
      root.HyperoneClient = {};
    }
    root.HyperoneClient.ProjectLimit = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.ProjectLimitAgent, root.HyperoneClient.ProjectLimitContainer, root.HyperoneClient.ProjectLimitDisk, root.HyperoneClient.ProjectLimitNetwork, root.HyperoneClient.ProjectLimitPolicy, root.HyperoneClient.ProjectLimitRegistry, root.HyperoneClient.ProjectLimitReservation, root.HyperoneClient.ProjectLimitRole, root.HyperoneClient.ProjectLimitSa, root.HyperoneClient.ProjectLimitSnapshot, root.HyperoneClient.ProjectLimitVault, root.HyperoneClient.ProjectLimitVm, root.HyperoneClient.ProjectLimitVolume);
  }
}(this, function(ApiClient, ProjectLimitAgent, ProjectLimitContainer, ProjectLimitDisk, ProjectLimitNetwork, ProjectLimitPolicy, ProjectLimitRegistry, ProjectLimitReservation, ProjectLimitRole, ProjectLimitSa, ProjectLimitSnapshot, ProjectLimitVault, ProjectLimitVm, ProjectLimitVolume) {
  'use strict';
  ...
  exports.constructFromObject = function(data, obj) {
    if (data) {
      ...
      if (data.hasOwnProperty('policy')) {
        obj['policy'] = ProjectLimitPolicy.constructFromObject(data['policy']);
      }
      if (data.hasOwnProperty('replica')) {
        obj['replica'] = ProjectLimitAgent.constructFromObject(data['replica']);
      }
      if (data.hasOwnProperty('role')) {
        obj['role'] = ProjectLimitRole.constructFromObject(data['role']);
      }
      if (data.hasOwnProperty('sa')) {
        obj['sa'] = ProjectLimitSa.constructFromObject(data['sa']);
      }
  ...
  /**
   * @member {module:model/ProjectLimitPolicy} policy
   */
  exports.prototype['policy'] = undefined;
  /**
   * @member {module:model/ProjectLimitAgent} replica
   */
  exports.prototype['replica'] = undefined;
  /**
   * @member {module:model/ProjectLimitRole} role
   */
  exports.prototype['role'] = undefined;
  /**
   * @member {module:model/ProjectLimitSa} sa
   */
  exports.prototype['sa'] = undefined;
  /**
