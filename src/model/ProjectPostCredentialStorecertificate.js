 ...
 * @version 0.0.3
 */
class ProjectPostCredentialStorecertificate {
    /**
    ...
    constructor(name, type, value) { 
        ...
        ProjectPostCredentialStorecertificate.initialize(this, name, type, value);
    }
    ...
    static constructFromObject(data, obj) {
        if (data) {
            obj = obj || new ProjectPostCredentialStorecertificate();
 ...
 * @member {String} name
 */
ProjectPostCredentialStorecertificate.prototype['name'] = undefined;

/**
 * @member {String} type
 */
ProjectPostCredentialStorecertificate.prototype['type'] = undefined;

/**
 * @member {String} value
 */
ProjectPostCredentialStorecertificate.prototype['value'] = undefined;

/**
 * @member {String} token
 */
ProjectPostCredentialStorecertificate.prototype['token'] = undefined;
...
export default ProjectPostCredentialStorecertificate;
