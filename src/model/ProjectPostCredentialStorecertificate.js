...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    root.HyperOneApi.ProjectPostCredentialStorecertificate = factory(root.HyperOneApi.ApiClient);
  }
   ...
   * @class
   * @param name {String} 
   * @param type {module:model/ProjectPostCredentialStorecertificate.TypeEnum} 
   * @param value {String} 
   */
  ...
  /**
   * @member {module:model/ProjectPostCredentialStorecertificate.TypeEnum} type
   */
