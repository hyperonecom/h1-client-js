...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Event', 'model/ProjectAccessRights', 'model/ProjectBilling', 'model/ProjectCompliance', 'model/ProjectLimit', 'model/ProjectRoles', 'model/ProjectServices', 'model/ProjectThreshold', 'model/ProjectTransfer', 'model/UserNetworkAcl'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Event'), require('./ProjectAccessRights'), require('./ProjectBilling'), require('./ProjectCompliance'), require('./ProjectLimit'), require('./ProjectRoles'), require('./ProjectServices'), require('./ProjectThreshold'), require('./ProjectTransfer'), require('./UserNetworkAcl'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperoneClient) {
      root.HyperoneClient = {};
    }
    root.HyperoneClient.Project = factory(root.HyperoneClient.ApiClient, root.HyperoneClient.Event, root.HyperoneClient.ProjectAccessRights, root.HyperoneClient.ProjectBilling, root.HyperoneClient.ProjectCompliance, root.HyperoneClient.ProjectLimit, root.HyperoneClient.ProjectRoles, root.HyperoneClient.ProjectServices, root.HyperoneClient.ProjectThreshold, root.HyperoneClient.ProjectTransfer, root.HyperoneClient.UserNetworkAcl);
  }
}(this, function(ApiClient, Event, ProjectAccessRights, ProjectBilling, ProjectCompliance, ProjectLimit, ProjectRoles, ProjectServices, ProjectThreshold, ProjectTransfer, UserNetworkAcl) {
  'use strict';
