...
(function(root, factory) {
  if (typeof define === 'function' && define.amd) {
    ...
    define(['ApiClient', 'model/Event', 'model/ProjectAccessRights1', 'model/ProjectBilling', 'model/ProjectCompliance', 'model/ProjectInvoices', 'model/ProjectNetworkAcl', 'model/ProjectPayments', 'model/ProjectThreshold', 'model/ProjectTransfer'], factory);
  } else if (typeof module === 'object' && module.exports) {
    // CommonJS-like environments that support module.exports, like Node.
    module.exports = factory(require('../ApiClient'), require('./Event'), require('./ProjectAccessRights1'), require('./ProjectBilling'), require('./ProjectCompliance'), require('./ProjectInvoices'), require('./ProjectNetworkAcl'), require('./ProjectPayments'), require('./ProjectThreshold'), require('./ProjectTransfer'));
  } else {
    // Browser globals (root is window)
    if (!root.HyperOneApi) {
      root.HyperOneApi = {};
    }
    root.HyperOneApi.Project = factory(root.HyperOneApi.ApiClient, root.HyperOneApi.Event, root.HyperOneApi.ProjectAccessRights1, root.HyperOneApi.ProjectBilling, root.HyperOneApi.ProjectCompliance, root.HyperOneApi.ProjectInvoices, root.HyperOneApi.ProjectNetworkAcl, root.HyperOneApi.ProjectPayments, root.HyperOneApi.ProjectThreshold, root.HyperOneApi.ProjectTransfer);
  }
}(this, function(ApiClient, Event, ProjectAccessRights1, ProjectBilling, ProjectCompliance, ProjectInvoices, ProjectNetworkAcl, ProjectPayments, ProjectThreshold, ProjectTransfer) {
  'use strict';
