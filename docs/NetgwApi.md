...
> Netgw netgwActionAttach(netgwId, netgwActionAttach)
...
var netgwActionAttach = new HyperOneApi.NetgwActionAttach(); // NetgwActionAttach | 
apiInstance.netgwActionAttach(netgwId, netgwActionAttach).then(function(data) {
