...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VaultApi();
  });
  ...
  describe('VaultApi', function() {
    ...
    describe('vaultDeleteCredentialId', function() {
      it('should call vaultDeleteCredentialId successfully', function(done) {
        //uncomment below and update the code to test vaultDeleteCredentialId
        //instance.vaultDeleteCredentialId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vaultGetCredentialId', function() {
      it('should call vaultGetCredentialId successfully', function(done) {
        //uncomment below and update the code to test vaultGetCredentialId
        //instance.vaultGetCredentialId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vaultListCredential', function() {
      it('should call vaultListCredential successfully', function(done) {
        //uncomment below and update the code to test vaultListCredential
        //instance.vaultListCredential(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vaultPatchCredentialId', function() {
      it('should call vaultPatchCredentialId successfully', function(done) {
        //uncomment below and update the code to test vaultPatchCredentialId
        //instance.vaultPatchCredentialId(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vaultPostCredential', function() {
      it('should call vaultPostCredential successfully', function(done) {
        //uncomment below and update the code to test vaultPostCredential
        //instance.vaultPostCredential(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vaultPutTag', function() {
      it('should call vaultPutTag successfully', function(done) {
        //uncomment below and update the code to test vaultPutTag
        //instance.vaultPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
