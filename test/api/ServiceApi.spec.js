...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ServiceApi();
  });
  ...
  describe('ServiceApi', function() {
    ...
    describe('serviceShow', function() {
      it('should call serviceShow successfully', function(done) {
        //uncomment below and update the code to test serviceShow
        //instance.serviceShow(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
