...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReservationApi();
  });
  ...
  describe('ReservationApi', function() {
    ...
    describe('reservationPutTag', function() {
      it('should call reservationPutTag successfully', function(done) {
        //uncomment below and update the code to test reservationPutTag
        //instance.reservationPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
