...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VolumeApi();
  });
  ...
  describe('VolumeApi', function() {
    ...
    describe('volumePutTag', function() {
      it('should call volumePutTag successfully', function(done) {
        //uncomment below and update the code to test volumePutTag
        //instance.volumePutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
