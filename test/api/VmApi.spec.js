...
(function(root, factory) {
  ...
  describe('VmApi', function() {
    ...
    describe('vmDeleteNetadp', function() {
      it('should call vmDeleteNetadp successfully', function(done) {
        //uncomment below and update the code to test vmDeleteNetadp
        //instance.vmDeleteNetadp(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
