...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VmApi();
  });
  ...
  describe('VmApi', function() {
    ...
    describe('vmGetConsole', function() {
      it('should call vmGetConsole successfully', function(done) {
        //uncomment below and update the code to test vmGetConsole
        //instance.vmGetConsole(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('vmPutTag', function() {
      it('should call vmPutTag successfully', function(done) {
        //uncomment below and update the code to test vmPutTag
        //instance.vmPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
