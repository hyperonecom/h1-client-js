...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.FirewallApi();
  });
  ...
  describe('FirewallApi', function() {
    ...
    describe('firewallPutEgress', function() {
      it('should call firewallPutEgress successfully', function(done) {
        //uncomment below and update the code to test firewallPutEgress
        //instance.firewallPutEgress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('firewallPutIngress', function() {
      it('should call firewallPutIngress successfully', function(done) {
        //uncomment below and update the code to test firewallPutIngress
        //instance.firewallPutIngress(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('firewallPutTag', function() {
      it('should call firewallPutTag successfully', function(done) {
        //uncomment below and update the code to test firewallPutTag
        //instance.firewallPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
