...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetgwApi();
  });
  ...
  describe('NetgwApi', function() {
    ...
    describe('netgwPutTag', function() {
      it('should call netgwPutTag successfully', function(done) {
        //uncomment below and update the code to test netgwPutTag
        //instance.netgwPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
