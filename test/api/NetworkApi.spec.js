...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetworkApi();
  });
  ...
  describe('NetworkApi', function() {
    describe('networkActionFirewallAdd', function() {
      it('should call networkActionFirewallAdd successfully', function(done) {
        //uncomment below and update the code to test networkActionFirewallAdd
        //instance.networkActionFirewallAdd(function(error) {
    ...
    describe('networkActionFirewallRemove', function() {
      it('should call networkActionFirewallRemove successfully', function(done) {
        //uncomment below and update the code to test networkActionFirewallRemove
        //instance.networkActionFirewallRemove(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('networkPutTag', function() {
      it('should call networkPutTag successfully', function(done) {
        //uncomment below and update the code to test networkPutTag
        //instance.networkPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
