...
(function(root, factory) {
  ...
  describe('ProjectApi', function() {
    ...
    describe('projectListLimit', function() {
      it('should call projectListLimit successfully', function(done) {
        //uncomment below and update the code to test projectListLimit
        //instance.projectListLimit(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
