...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReplicaApi();
  });
  ...
  describe('ReplicaApi', function() {
    ...
    describe('replicaPutTag', function() {
      it('should call replicaPutTag successfully', function(done) {
        //uncomment below and update the code to test replicaPutTag
        //instance.replicaPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
