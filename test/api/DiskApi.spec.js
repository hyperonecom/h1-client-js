...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.DiskApi();
  });
  ...
  describe('DiskApi', function() {
    ...
    describe('diskGetDownload', function() {
      it('should call diskGetDownload successfully', function(done) {
        //uncomment below and update the code to test diskGetDownload
        //instance.diskGetDownload(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
    ...
    describe('diskPutTag', function() {
      it('should call diskPutTag successfully', function(done) {
        //uncomment below and update the code to test diskPutTag
        //instance.diskPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
