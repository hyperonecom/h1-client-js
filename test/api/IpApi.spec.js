...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.IpApi();
  });
  ...
  describe('IpApi', function() {
    ...
    describe('ipPutTag', function() {
      it('should call ipPutTag successfully', function(done) {
        //uncomment below and update the code to test ipPutTag
        //instance.ipPutTag(function(error) {
        //  if (error) throw error;
        //expect().to.be();
        //});
        done();
