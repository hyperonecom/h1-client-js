...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.FirewallPostIngress();
  });
  ...
  describe('FirewallPostIngress', function() {
    it('should create an instance of FirewallPostIngress', function() {
      ...
      //var instane = new HyperoneClient.FirewallPostIngress();
      //expect(instance).to.be.a(HyperoneClient.FirewallPostIngress);
    });
