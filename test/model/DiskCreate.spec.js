...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.DiskCreate();
  });
  ...
  describe('DiskCreate', function() {
    it('should create an instance of DiskCreate', function() {
      // uncomment below and update the code to test DiskCreate
      //var instane = new HyperoneClient.DiskCreate();
      //expect(instance).to.be.a(HyperoneClient.DiskCreate);
    });
