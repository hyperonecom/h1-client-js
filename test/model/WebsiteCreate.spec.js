...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.WebsiteCreate();
  });
  ...
  describe('WebsiteCreate', function() {
    it('should create an instance of WebsiteCreate', function() {
      // uncomment below and update the code to test WebsiteCreate
      //var instane = new HyperoneClient.WebsiteCreate();
      //expect(instance).to.be.a(HyperoneClient.WebsiteCreate);
    });
