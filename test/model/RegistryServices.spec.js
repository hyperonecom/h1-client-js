...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.RegistryServices();
  });
  ...
  describe('RegistryServices', function() {
    it('should create an instance of RegistryServices', function() {
      // uncomment below and update the code to test RegistryServices
      //var instane = new HyperoneClient.RegistryServices();
      //expect(instance).to.be.a(HyperoneClient.RegistryServices);
    });
