...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VmPostAccessrights();
  });
  ...
  describe('VmPostAccessrights', function() {
    it('should create an instance of VmPostAccessrights', function() {
      // uncomment below and update the code to test VmPostAccessrights
      //var instane = new HyperoneClient.VmPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.VmPostAccessrights);
    });
