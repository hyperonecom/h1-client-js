...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ServiceBillingReservations();
  });
  ...
  describe('ServiceBillingReservations', function() {
    it('should create an instance of ServiceBillingReservations', function() {
      ...
      //var instane = new HyperoneClient.ServiceBillingReservations();
      //expect(instance).to.be.a(HyperoneClient.ServiceBillingReservations);
    });
