...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VolumeCreate();
  });
  ...
  describe('VolumeCreate', function() {
    it('should create an instance of VolumeCreate', function() {
      // uncomment below and update the code to test VolumeCreate
      //var instane = new HyperoneClient.VolumeCreate();
      //expect(instance).to.be.a(HyperoneClient.VolumeCreate);
    });
