...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.FirewallCreateIngress();
  });
  ...
  describe('FirewallCreateIngress', function() {
    it('should create an instance of FirewallCreateIngress', function() {
      // uncomment below and update the code to test FirewallCreateIngress
      //var instane = new HyperoneClient.FirewallCreateIngress();
      //expect(instance).to.be.a(HyperoneClient.FirewallCreateIngress);
    });
