...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.LogArchivePostAccessrights();
  });
  ...
  describe('LogArchivePostAccessrights', function() {
    it('should create an instance of LogArchivePostAccessrights', function() {
      // uncomment below and update the code to test LogArchivePostAccessrights
      //var instance = new HyperOneApi.LogArchivePostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.LogArchivePostAccessrights);
    });
