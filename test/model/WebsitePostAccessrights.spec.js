...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.WebsitePostAccessrights();
  });
  ...
  describe('WebsitePostAccessrights', function() {
    it('should create an instance of WebsitePostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.WebsitePostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.WebsitePostAccessrights);
    });
