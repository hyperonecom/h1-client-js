...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.WebsitePostAccessrights();
  });
  ...
  describe('WebsitePostAccessrights', function() {
    it('should create an instance of WebsitePostAccessrights', function() {
      // uncomment below and update the code to test WebsitePostAccessrights
      //var instane = new HyperoneClient.WebsitePostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.WebsitePostAccessrights);
    });
