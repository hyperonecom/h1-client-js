...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.FirewallPostAccessrights();
  });
  ...
  describe('FirewallPostAccessrights', function() {
    it('should create an instance of FirewallPostAccessrights', function() {
      // uncomment below and update the code to test FirewallPostAccessrights
      //var instane = new HyperoneClient.FirewallPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.FirewallPostAccessrights);
    });
