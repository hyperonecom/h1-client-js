...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.FirewallPostAccessrights();
  });
  ...
  describe('FirewallPostAccessrights', function() {
    it('should create an instance of FirewallPostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.FirewallPostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.FirewallPostAccessrights);
    });
