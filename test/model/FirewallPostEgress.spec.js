...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.FirewallPostEgress();
  });
  ...
  describe('FirewallPostEgress', function() {
    it('should create an instance of FirewallPostEgress', function() {
      // uncomment below and update the code to test FirewallPostEgress
      //var instane = new HyperoneClient.FirewallPostEgress();
      //expect(instance).to.be.a(HyperoneClient.FirewallPostEgress);
    });
