...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.ReservationActionAssign();
  });
  ...
  describe('ReservationActionAssign', function() {
    it('should create an instance of ReservationActionAssign', function() {
      ...
      //var instance = new HyperOneApi.ReservationActionAssign();
      //expect(instance).to.be.a(HyperOneApi.ReservationActionAssign);
    });
