...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReservationActionAssign();
  });
  ...
  describe('ReservationActionAssign', function() {
    it('should create an instance of ReservationActionAssign', function() {
      // uncomment below and update the code to test ReservationActionAssign
      //var instane = new HyperoneClient.ReservationActionAssign();
      //expect(instance).to.be.a(HyperoneClient.ReservationActionAssign);
    });
