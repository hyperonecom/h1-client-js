...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.OrganisationUpdate();
  });
  ...
  describe('OrganisationUpdate', function() {
    it('should create an instance of OrganisationUpdate', function() {
      // uncomment below and update the code to test OrganisationUpdate
      //var instane = new HyperoneClient.OrganisationUpdate();
      //expect(instance).to.be.a(HyperoneClient.OrganisationUpdate);
    });
