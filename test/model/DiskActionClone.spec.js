...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.DiskActionClone();
  });
  ...
  describe('DiskActionClone', function() {
    it('should create an instance of DiskActionClone', function() {
      // uncomment below and update the code to test DiskActionClone
      //var instane = new HyperoneClient.DiskActionClone();
      //expect(instance).to.be.a(HyperoneClient.DiskActionClone);
    });
