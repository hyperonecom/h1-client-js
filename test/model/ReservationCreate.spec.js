...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReservationCreate();
  });
  ...
  describe('ReservationCreate', function() {
    it('should create an instance of ReservationCreate', function() {
      // uncomment below and update the code to test ReservationCreate
      //var instane = new HyperoneClient.ReservationCreate();
      //expect(instance).to.be.a(HyperoneClient.ReservationCreate);
    });
