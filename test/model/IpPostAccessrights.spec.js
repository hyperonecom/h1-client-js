...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.IpPostAccessrights();
  });
  ...
  describe('IpPostAccessrights', function() {
    it('should create an instance of IpPostAccessrights', function() {
      // uncomment below and update the code to test IpPostAccessrights
      //var instane = new HyperoneClient.IpPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.IpPostAccessrights);
    });
