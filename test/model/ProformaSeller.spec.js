...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ProformaSeller();
  });
  ...
  describe('ProformaSeller', function() {
    it('should create an instance of ProformaSeller', function() {
      // uncomment below and update the code to test ProformaSeller
      //var instane = new HyperoneClient.ProformaSeller();
      //expect(instance).to.be.a(HyperoneClient.ProformaSeller);
    });
