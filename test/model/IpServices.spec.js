...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.IpServices();
  });
  ...
  describe('IpServices', function() {
    it('should create an instance of IpServices', function() {
      // uncomment below and update the code to test IpServices
      //var instane = new HyperoneClient.IpServices();
      //expect(instance).to.be.a(HyperoneClient.IpServices);
    });
