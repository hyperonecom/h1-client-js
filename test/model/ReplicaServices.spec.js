...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReplicaServices();
  });
  ...
  describe('ReplicaServices', function() {
    it('should create an instance of ReplicaServices', function() {
      // uncomment below and update the code to test ReplicaServices
      //var instane = new HyperoneClient.ReplicaServices();
      //expect(instance).to.be.a(HyperoneClient.ReplicaServices);
    });
