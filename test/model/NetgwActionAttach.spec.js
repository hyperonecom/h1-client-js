...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetgwActionAttach();
  });
  ...
  describe('NetgwActionAttach', function() {
    it('should create an instance of NetgwActionAttach', function() {
      // uncomment below and update the code to test NetgwActionAttach
      //var instane = new HyperoneClient.NetgwActionAttach();
      //expect(instance).to.be.a(HyperoneClient.NetgwActionAttach);
    });
