...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetworkPostAccessrights();
  });
  ...
  describe('NetworkPostAccessrights', function() {
    it('should create an instance of NetworkPostAccessrights', function() {
      ...
      //var instane = new HyperoneClient.NetworkPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.NetworkPostAccessrights);
    });
