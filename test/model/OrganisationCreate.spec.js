...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.OrganisationCreate();
  });
  ...
  describe('OrganisationCreate', function() {
    it('should create an instance of OrganisationCreate', function() {
      // uncomment below and update the code to test OrganisationCreate
      //var instane = new HyperoneClient.OrganisationCreate();
      //expect(instance).to.be.a(HyperoneClient.OrganisationCreate);
    });
