...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.IsoCreate();
  });
  ...
  describe('IsoCreate', function() {
    it('should create an instance of IsoCreate', function() {
      // uncomment below and update the code to test IsoCreate
      //var instane = new HyperoneClient.IsoCreate();
      //expect(instance).to.be.a(HyperoneClient.IsoCreate);
    });
