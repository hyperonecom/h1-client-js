...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ZoneRecordset0();
  });
  ...
  describe('ZoneRecordset0', function() {
    it('should create an instance of ZoneRecordset0', function() {
      // uncomment below and update the code to test ZoneRecordset0
      //var instane = new HyperoneClient.ZoneRecordset0();
      //expect(instance).to.be.a(HyperoneClient.ZoneRecordset0);
    });
