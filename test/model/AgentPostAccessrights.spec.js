...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.AgentPostAccessrights();
  });
  ...
  describe('AgentPostAccessrights', function() {
    it('should create an instance of AgentPostAccessrights', function() {
      // uncomment below and update the code to test AgentPostAccessrights
      //var instane = new HyperoneClient.AgentPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.AgentPostAccessrights);
    });
