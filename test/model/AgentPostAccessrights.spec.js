...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.AgentPostAccessrights();
  });
  ...
  describe('AgentPostAccessrights', function() {
    it('should create an instance of AgentPostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.AgentPostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.AgentPostAccessrights);
    });
