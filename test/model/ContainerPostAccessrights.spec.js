...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ContainerPostAccessrights();
  });
  ...
  describe('ContainerPostAccessrights', function() {
    it('should create an instance of ContainerPostAccessrights', function() {
      // uncomment below and update the code to test ContainerPostAccessrights
      //var instane = new HyperoneClient.ContainerPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.ContainerPostAccessrights);
    });
