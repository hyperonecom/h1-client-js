...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.ContainerPostAccessrights();
  });
  ...
  describe('ContainerPostAccessrights', function() {
    it('should create an instance of ContainerPostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.ContainerPostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.ContainerPostAccessrights);
    });
