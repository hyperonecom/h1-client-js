...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.IsoServices();
  });
  ...
  describe('IsoServices', function() {
    it('should create an instance of IsoServices', function() {
      // uncomment below and update the code to test IsoServices
      //var instane = new HyperoneClient.IsoServices();
      //expect(instance).to.be.a(HyperoneClient.IsoServices);
    });
