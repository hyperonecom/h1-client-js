...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.RegistryPostAccessrights();
  });
  ...
  describe('RegistryPostAccessrights', function() {
    it('should create an instance of RegistryPostAccessrights', function() {
      // uncomment below and update the code to test RegistryPostAccessrights
      //var instane = new HyperoneClient.RegistryPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.RegistryPostAccessrights);
    });
