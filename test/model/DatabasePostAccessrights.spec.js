...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.DatabasePostAccessrights();
  });
  ...
  describe('DatabasePostAccessrights', function() {
    it('should create an instance of DatabasePostAccessrights', function() {
      // uncomment below and update the code to test DatabasePostAccessrights
      //var instane = new HyperoneClient.DatabasePostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.DatabasePostAccessrights);
    });
