...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.DatabasePostAccessrights();
  });
  ...
  describe('DatabasePostAccessrights', function() {
    it('should create an instance of DatabasePostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.DatabasePostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.DatabasePostAccessrights);
    });
