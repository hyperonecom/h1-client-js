...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ZonePatchRecordsetRecordsetId();
  });
  ...
  describe('ZonePatchRecordsetRecordsetId', function() {
    it('should create an instance of ZonePatchRecordsetRecordsetId', function() {
      // uncomment below and update the code to test ZonePatchRecordsetRecordsetId
      //var instane = new HyperoneClient.ZonePatchRecordsetRecordsetId();
      //expect(instance).to.be.a(HyperoneClient.ZonePatchRecordsetRecordsetId);
    });
