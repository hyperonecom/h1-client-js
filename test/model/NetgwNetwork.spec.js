...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new HyperOneApi.NetgwNetwork();
    });
    ...
    describe('NetgwNetwork', function() {
        it('should create an instance of NetgwNetwork', function() {
            // uncomment below and update the code to test NetgwNetwork
            //var instance = new HyperOneApi.NetgwNetwork();
            //expect(instance).to.be.a(HyperOneApi.NetgwNetwork);
        });
