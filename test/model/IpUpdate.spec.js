...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.IpUpdate();
  });
  ...
  describe('IpUpdate', function() {
    it('should create an instance of IpUpdate', function() {
      // uncomment below and update the code to test IpUpdate
      //var instane = new HyperoneClient.IpUpdate();
      //expect(instance).to.be.a(HyperoneClient.IpUpdate);
    });
