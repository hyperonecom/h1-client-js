...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.DiskPostAccessrights();
  });
  ...
  describe('DiskPostAccessrights', function() {
    it('should create an instance of DiskPostAccessrights', function() {
      // uncomment below and update the code to test DiskPostAccessrights
      //var instane = new HyperoneClient.DiskPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.DiskPostAccessrights);
    });
