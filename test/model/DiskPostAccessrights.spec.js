...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.DiskPostAccessrights();
  });
  ...
  describe('DiskPostAccessrights', function() {
    it('should create an instance of DiskPostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.DiskPostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.DiskPostAccessrights);
    });
