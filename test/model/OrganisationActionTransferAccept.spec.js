...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.OrganisationActionTransferAccept();
  });
  ...
  describe('OrganisationActionTransferAccept', function() {
    it('should create an instance of OrganisationActionTransferAccept', function() {
      // uncomment below and update the code to test OrganisationActionTransferAccept
      //var instane = new HyperoneClient.OrganisationActionTransferAccept();
      //expect(instance).to.be.a(HyperoneClient.OrganisationActionTransferAccept);
    });
