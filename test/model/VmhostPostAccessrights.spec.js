...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VmhostPostAccessrights();
  });
  ...
  describe('VmhostPostAccessrights', function() {
    it('should create an instance of VmhostPostAccessrights', function() {
      // uncomment below and update the code to test VmhostPostAccessrights
      //var instane = new HyperoneClient.VmhostPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.VmhostPostAccessrights);
    });
