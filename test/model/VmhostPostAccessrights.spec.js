...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.VmhostPostAccessrights();
  });
  ...
  describe('VmhostPostAccessrights', function() {
    it('should create an instance of VmhostPostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.VmhostPostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.VmhostPostAccessrights);
    });
