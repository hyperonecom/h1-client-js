...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ZoneServices();
  });
  ...
  describe('ZoneServices', function() {
    it('should create an instance of ZoneServices', function() {
      // uncomment below and update the code to test ZoneServices
      //var instane = new HyperoneClient.ZoneServices();
      //expect(instance).to.be.a(HyperoneClient.ZoneServices);
    });
