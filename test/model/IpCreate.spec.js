...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.IpCreate();
  });
  ...
  describe('IpCreate', function() {
    it('should create an instance of IpCreate', function() {
      // uncomment below and update the code to test IpCreate
      //var instane = new HyperoneClient.IpCreate();
      //expect(instance).to.be.a(HyperoneClient.IpCreate);
    });
