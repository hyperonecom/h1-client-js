...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.Netadp();
  });
  ...
  describe('Netadp', function() {
    it('should create an instance of Netadp', function() {
      // uncomment below and update the code to test Netadp
      //var instane = new HyperoneClient.Netadp();
      //expect(instance).to.be.a(HyperoneClient.Netadp);
    });
