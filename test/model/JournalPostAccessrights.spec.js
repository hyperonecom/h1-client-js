...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.JournalPostAccessrights();
  });
  ...
  describe('JournalPostAccessrights', function() {
    it('should create an instance of JournalPostAccessrights', function() {
      // uncomment below and update the code to test JournalPostAccessrights
      //var instane = new HyperoneClient.JournalPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.JournalPostAccessrights);
    });
