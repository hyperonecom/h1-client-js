...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.SnapshotServices();
  });
  ...
  describe('SnapshotServices', function() {
    it('should create an instance of SnapshotServices', function() {
      // uncomment below and update the code to test SnapshotServices
      //var instane = new HyperoneClient.SnapshotServices();
      //expect(instance).to.be.a(HyperoneClient.SnapshotServices);
    });
