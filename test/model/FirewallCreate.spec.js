...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.FirewallCreate();
  });
  ...
  describe('FirewallCreate', function() {
    it('should create an instance of FirewallCreate', function() {
      // uncomment below and update the code to test FirewallCreate
      //var instane = new HyperoneClient.FirewallCreate();
      //expect(instance).to.be.a(HyperoneClient.FirewallCreate);
    });
