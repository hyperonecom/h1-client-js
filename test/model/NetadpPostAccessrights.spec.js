...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetadpPostAccessrights();
  });
  ...
  describe('NetadpPostAccessrights', function() {
    it('should create an instance of NetadpPostAccessrights', function() {
      // uncomment below and update the code to test NetadpPostAccessrights
      //var instane = new HyperoneClient.NetadpPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.NetadpPostAccessrights);
    });
