...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.NetadpPostAccessrights();
  });
  ...
  describe('NetadpPostAccessrights', function() {
    it('should create an instance of NetadpPostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.NetadpPostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.NetadpPostAccessrights);
    });
