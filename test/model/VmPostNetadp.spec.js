...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VmPostNetadp();
  });
  ...
  describe('VmPostNetadp', function() {
    it('should create an instance of VmPostNetadp', function() {
      // uncomment below and update the code to test VmPostNetadp
      //var instane = new HyperoneClient.VmPostNetadp();
      //expect(instance).to.be.a(HyperoneClient.VmPostNetadp);
    });
