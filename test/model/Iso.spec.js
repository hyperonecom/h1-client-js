...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.Iso();
  });
  ...
  describe('Iso', function() {
    it('should create an instance of Iso', function() {
      // uncomment below and update the code to test Iso
      //var instane = new HyperoneClient.Iso();
      //expect(instance).to.be.a(HyperoneClient.Iso);
    });
