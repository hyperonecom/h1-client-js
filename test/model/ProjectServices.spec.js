...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ProjectServices();
  });
  ...
  describe('ProjectServices', function() {
    it('should create an instance of ProjectServices', function() {
      // uncomment below and update the code to test ProjectServices
      //var instane = new HyperoneClient.ProjectServices();
      //expect(instance).to.be.a(HyperoneClient.ProjectServices);
    });
