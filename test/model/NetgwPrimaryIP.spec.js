...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.NetgwPrimaryIP();
  });
  ...
  describe('NetgwPrimaryIP', function() {
    it('should create an instance of NetgwPrimaryIP', function() {
      // uncomment below and update the code to test NetgwPrimaryIP
      //var instance = new HyperOneApi.NetgwPrimaryIP();
      //expect(instance).to.be.a(HyperOneApi.NetgwPrimaryIP);
    });
