...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.UserServices();
  });
  ...
  describe('UserServices', function() {
    it('should create an instance of UserServices', function() {
      // uncomment below and update the code to test UserServices
      //var instane = new HyperoneClient.UserServices();
      //expect(instance).to.be.a(HyperoneClient.UserServices);
    });
