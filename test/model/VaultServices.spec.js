...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VaultServices();
  });
  ...
  describe('VaultServices', function() {
    it('should create an instance of VaultServices', function() {
      // uncomment below and update the code to test VaultServices
      //var instane = new HyperoneClient.VaultServices();
      //expect(instance).to.be.a(HyperoneClient.VaultServices);
    });
