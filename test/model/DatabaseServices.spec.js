...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.DatabaseServices();
  });
  ...
  describe('DatabaseServices', function() {
    it('should create an instance of DatabaseServices', function() {
      // uncomment below and update the code to test DatabaseServices
      //var instane = new HyperoneClient.DatabaseServices();
      //expect(instance).to.be.a(HyperoneClient.DatabaseServices);
    });
