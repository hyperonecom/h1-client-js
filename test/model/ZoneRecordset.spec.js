...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ZoneRecordset();
  });
  ...
  describe('ZoneRecordset', function() {
    it('should create an instance of ZoneRecordset', function() {
      // uncomment below and update the code to test ZoneRecordset
      //var instane = new HyperoneClient.ZoneRecordset();
      //expect(instance).to.be.a(HyperoneClient.ZoneRecordset);
    });
