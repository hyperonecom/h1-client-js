...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReservationPostAccessrights();
  });
  ...
  describe('ReservationPostAccessrights', function() {
    it('should create an instance of ReservationPostAccessrights', function() {
      // uncomment below and update the code to test ReservationPostAccessrights
      //var instane = new HyperoneClient.ReservationPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.ReservationPostAccessrights);
    });
