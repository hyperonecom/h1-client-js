...
(function(root, factory) {
    ...
    beforeEach(function() {
        instance = new HyperOneApi.InlineObject46();
    });
    ...
    describe('InlineObject46', function() {
        it('should create an instance of InlineObject46', function() {
            // uncomment below and update the code to test InlineObject46
            //var instance = new HyperOneApi.InlineObject46();
            //expect(instance).to.be.a(HyperOneApi.InlineObject46);
        });
