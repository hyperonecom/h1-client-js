...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetadpServices();
  });
  ...
  describe('NetadpServices', function() {
    it('should create an instance of NetadpServices', function() {
      // uncomment below and update the code to test NetadpServices
      //var instane = new HyperoneClient.NetadpServices();
      //expect(instance).to.be.a(HyperoneClient.NetadpServices);
    });
