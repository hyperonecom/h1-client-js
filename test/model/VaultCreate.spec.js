...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VaultCreate();
  });
  ...
  describe('VaultCreate', function() {
    it('should create an instance of VaultCreate', function() {
      // uncomment below and update the code to test VaultCreate
      //var instane = new HyperoneClient.VaultCreate();
      //expect(instance).to.be.a(HyperoneClient.VaultCreate);
    });
