...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReplicaPostAccessrights();
  });
  ...
  describe('ReplicaPostAccessrights', function() {
    it('should create an instance of ReplicaPostAccessrights', function() {
      ...
      //var instane = new HyperoneClient.ReplicaPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.ReplicaPostAccessrights);
    });
