...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.JournalCreate();
  });
  ...
  describe('JournalCreate', function() {
    it('should create an instance of JournalCreate', function() {
      // uncomment below and update the code to test JournalCreate
      //var instane = new HyperoneClient.JournalCreate();
      //expect(instance).to.be.a(HyperoneClient.JournalCreate);
    });
