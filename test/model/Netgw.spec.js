...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.Netgw();
  });
  ...
  describe('Netgw', function() {
    it('should create an instance of Netgw', function() {
      // uncomment below and update the code to test Netgw
      //var instane = new HyperoneClient.Netgw();
      //expect(instance).to.be.a(HyperoneClient.Netgw);
    });
    ...
    it('should have the property primaryIP (base name: "primaryIP")', function() {
