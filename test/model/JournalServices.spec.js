...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.JournalServices();
  });
  ...
  describe('JournalServices', function() {
    it('should create an instance of JournalServices', function() {
      // uncomment below and update the code to test JournalServices
      //var instane = new HyperoneClient.JournalServices();
      //expect(instance).to.be.a(HyperoneClient.JournalServices);
    });
