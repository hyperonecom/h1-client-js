...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReplicaActionImage();
  });
  ...
  describe('ReplicaActionImage', function() {
    it('should create an instance of ReplicaActionImage', function() {
      ...
      //var instane = new HyperoneClient.ReplicaActionImage();
      //expect(instance).to.be.a(HyperoneClient.ReplicaActionImage);
    });
