...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VaultActionSnapshot();
  });
  ...
  describe('VaultActionSnapshot', function() {
    it('should create an instance of VaultActionSnapshot', function() {
      // uncomment below and update the code to test VaultActionSnapshot
      //var instane = new HyperoneClient.VaultActionSnapshot();
      //expect(instance).to.be.a(HyperoneClient.VaultActionSnapshot);
    });
