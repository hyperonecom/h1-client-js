...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.SnapshotPostAccessrights();
  });
  ...
  describe('SnapshotPostAccessrights', function() {
    it('should create an instance of SnapshotPostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.SnapshotPostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.SnapshotPostAccessrights);
    });
