...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.SnapshotPostAccessrights();
  });
  ...
  describe('SnapshotPostAccessrights', function() {
    it('should create an instance of SnapshotPostAccessrights', function() {
      // uncomment below and update the code to test SnapshotPostAccessrights
      //var instane = new HyperoneClient.SnapshotPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.SnapshotPostAccessrights);
    });
