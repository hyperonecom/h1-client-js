...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.JournalActionUpdateRetention();
  });
  ...
  describe('JournalActionUpdateRetention', function() {
    it('should create an instance of JournalActionUpdateRetention', function() {
      // uncomment below and update the code to test JournalActionUpdateRetention
      //var instane = new HyperoneClient.JournalActionUpdateRetention();
      //expect(instance).to.be.a(HyperoneClient.JournalActionUpdateRetention);
    });
