...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ImageServices();
  });
  ...
  describe('ImageServices', function() {
    it('should create an instance of ImageServices', function() {
      // uncomment below and update the code to test ImageServices
      //var instane = new HyperoneClient.ImageServices();
      //expect(instance).to.be.a(HyperoneClient.ImageServices);
    });
