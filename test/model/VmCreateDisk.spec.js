...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VmCreateDisk();
  });
  ...
  describe('VmCreateDisk', function() {
    it('should create an instance of VmCreateDisk', function() {
      // uncomment below and update the code to test VmCreateDisk
      //var instane = new HyperoneClient.VmCreateDisk();
      //expect(instance).to.be.a(HyperoneClient.VmCreateDisk);
    });
