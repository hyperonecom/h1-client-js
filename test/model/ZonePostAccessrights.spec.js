...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ZonePostAccessrights();
  });
  ...
  describe('ZonePostAccessrights', function() {
    it('should create an instance of ZonePostAccessrights', function() {
      // uncomment below and update the code to test ZonePostAccessrights
      //var instane = new HyperoneClient.ZonePostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.ZonePostAccessrights);
    });
