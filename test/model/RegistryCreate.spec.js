...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.RegistryCreate();
  });
  ...
  describe('RegistryCreate', function() {
    it('should create an instance of RegistryCreate', function() {
      // uncomment below and update the code to test RegistryCreate
      //var instane = new HyperoneClient.RegistryCreate();
      //expect(instance).to.be.a(HyperoneClient.RegistryCreate);
    });
