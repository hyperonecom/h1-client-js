...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VmUpdate();
  });
  ...
  describe('VmUpdate', function() {
    it('should create an instance of VmUpdate', function() {
      // uncomment below and update the code to test VmUpdate
      //var instane = new HyperoneClient.VmUpdate();
      //expect(instance).to.be.a(HyperoneClient.VmUpdate);
    });
