...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ZoneRrsets();
  });
  ...
  describe('ZoneRrsets', function() {
    it('should create an instance of ZoneRrsets', function() {
      // uncomment below and update the code to test ZoneRrsets
      //var instane = new HyperoneClient.ZoneRrsets();
      //expect(instance).to.be.a(HyperoneClient.ZoneRrsets);
    });
