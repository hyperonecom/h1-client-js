...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.AgentCreate();
  });
  ...
  describe('AgentCreate', function() {
    it('should create an instance of AgentCreate', function() {
      // uncomment below and update the code to test AgentCreate
      //var instane = new HyperoneClient.AgentCreate();
      //expect(instance).to.be.a(HyperoneClient.AgentCreate);
    });
