...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.WebsiteServices();
  });
  ...
  describe('WebsiteServices', function() {
    it('should create an instance of WebsiteServices', function() {
      // uncomment below and update the code to test WebsiteServices
      //var instane = new HyperoneClient.WebsiteServices();
      //expect(instance).to.be.a(HyperoneClient.WebsiteServices);
    });
