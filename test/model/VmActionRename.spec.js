...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VmActionRename();
  });
  ...
  describe('VmActionRename', function() {
    it('should create an instance of VmActionRename', function() {
      // uncomment below and update the code to test VmActionRename
      //var instane = new HyperoneClient.VmActionRename();
      //expect(instance).to.be.a(HyperoneClient.VmActionRename);
    });
