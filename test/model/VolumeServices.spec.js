...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VolumeServices();
  });
  ...
  describe('VolumeServices', function() {
    it('should create an instance of VolumeServices', function() {
      // uncomment below and update the code to test VolumeServices
      //var instane = new HyperoneClient.VolumeServices();
      //expect(instance).to.be.a(HyperoneClient.VolumeServices);
    });
