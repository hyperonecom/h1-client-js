...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VmActionFlavour();
  });
  ...
  describe('VmActionFlavour', function() {
    it('should create an instance of VmActionFlavour', function() {
      // uncomment below and update the code to test VmActionFlavour
      //var instane = new HyperoneClient.VmActionFlavour();
      //expect(instance).to.be.a(HyperoneClient.VmActionFlavour);
    });
