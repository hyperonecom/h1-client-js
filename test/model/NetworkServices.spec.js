...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetworkServices();
  });
  ...
  describe('NetworkServices', function() {
    it('should create an instance of NetworkServices', function() {
      // uncomment below and update the code to test NetworkServices
      //var instane = new HyperoneClient.NetworkServices();
      //expect(instance).to.be.a(HyperoneClient.NetworkServices);
    });
