...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.DatabaseCreate();
  });
  ...
  describe('DatabaseCreate', function() {
    it('should create an instance of DatabaseCreate', function() {
      // uncomment below and update the code to test DatabaseCreate
      //var instane = new HyperoneClient.DatabaseCreate();
      //expect(instance).to.be.a(HyperoneClient.DatabaseCreate);
    });
