...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.AgentServices();
  });
  ...
  describe('AgentServices', function() {
    it('should create an instance of AgentServices', function() {
      // uncomment below and update the code to test AgentServices
      //var instane = new HyperoneClient.AgentServices();
      //expect(instance).to.be.a(HyperoneClient.AgentServices);
    });
