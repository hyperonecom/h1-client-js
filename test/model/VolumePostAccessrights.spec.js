...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.VolumePostAccessrights();
  });
  ...
  describe('VolumePostAccessrights', function() {
    it('should create an instance of VolumePostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.VolumePostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.VolumePostAccessrights);
    });
