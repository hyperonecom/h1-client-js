...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VolumePostAccessrights();
  });
  ...
  describe('VolumePostAccessrights', function() {
    it('should create an instance of VolumePostAccessrights', function() {
      // uncomment below and update the code to test VolumePostAccessrights
      //var instane = new HyperoneClient.VolumePostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.VolumePostAccessrights);
    });
