...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.IsoPostAccessrights();
  });
  ...
  describe('IsoPostAccessrights', function() {
    it('should create an instance of IsoPostAccessrights', function() {
      // uncomment below and update the code to test IsoPostAccessrights
      //var instane = new HyperoneClient.IsoPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.IsoPostAccessrights);
    });
