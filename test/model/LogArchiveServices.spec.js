...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.LogArchiveServices();
  });
  ...
  describe('LogArchiveServices', function() {
    it('should create an instance of LogArchiveServices', function() {
      // uncomment below and update the code to test LogArchiveServices
      //var instance = new HyperOneApi.LogArchiveServices();
      //expect(instance).to.be.a(HyperOneApi.LogArchiveServices);
    });
