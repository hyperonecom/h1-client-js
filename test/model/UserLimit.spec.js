...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.UserLimit();
  });
  ...
  describe('UserLimit', function() {
    it('should create an instance of UserLimit', function() {
      // uncomment below and update the code to test UserLimit
      //var instane = new HyperoneClient.UserLimit();
      //expect(instance).to.be.a(HyperoneClient.UserLimit);
    });
