...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.LogArchiveCreate();
  });
  ...
  describe('LogArchiveCreate', function() {
    it('should create an instance of LogArchiveCreate', function() {
      // uncomment below and update the code to test LogArchiveCreate
      //var instance = new HyperOneApi.LogArchiveCreate();
      //expect(instance).to.be.a(HyperOneApi.LogArchiveCreate);
    });
