...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.InlineObject60();
  });
  ...
  describe('InlineObject60', function() {
    it('should create an instance of InlineObject60', function() {
      // uncomment below and update the code to test InlineObject60
      //var instance = new HyperOneApi.InlineObject60();
      //expect(instance).to.be.a(HyperOneApi.InlineObject60);
    });
