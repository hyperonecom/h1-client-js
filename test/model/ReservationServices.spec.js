...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ReservationServices();
  });
  ...
  describe('ReservationServices', function() {
    it('should create an instance of ReservationServices', function() {
      // uncomment below and update the code to test ReservationServices
      //var instane = new HyperoneClient.ReservationServices();
      //expect(instance).to.be.a(HyperoneClient.ReservationServices);
    });
