...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.VaultPostAccessrights();
  });
  ...
  describe('VaultPostAccessrights', function() {
    it('should create an instance of VaultPostAccessrights', function() {
      // uncomment below and update the code to test VaultPostAccessrights
      //var instane = new HyperoneClient.VaultPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.VaultPostAccessrights);
    });
