...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.WebsiteActionUpdateDomain();
  });
  ...
  describe('WebsiteActionUpdateDomain', function() {
    it('should create an instance of WebsiteActionUpdateDomain', function() {
      ...
      //var instane = new HyperoneClient.WebsiteActionUpdateDomain();
      //expect(instance).to.be.a(HyperoneClient.WebsiteActionUpdateDomain);
    });
