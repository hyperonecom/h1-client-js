...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.NetgwPostAccessrights();
  });
  ...
  describe('NetgwPostAccessrights', function() {
    it('should create an instance of NetgwPostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.NetgwPostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.NetgwPostAccessrights);
    });
