...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetgwPostAccessrights();
  });
  ...
  describe('NetgwPostAccessrights', function() {
    it('should create an instance of NetgwPostAccessrights', function() {
      // uncomment below and update the code to test NetgwPostAccessrights
      //var instane = new HyperoneClient.NetgwPostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.NetgwPostAccessrights);
    });
