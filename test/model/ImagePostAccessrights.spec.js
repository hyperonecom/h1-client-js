...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.ImagePostAccessrights();
  });
  ...
  describe('ImagePostAccessrights', function() {
    it('should create an instance of ImagePostAccessrights', function() {
      // uncomment below and update the code to test ImagePostAccessrights
      //var instane = new HyperoneClient.ImagePostAccessrights();
      //expect(instance).to.be.a(HyperoneClient.ImagePostAccessrights);
    });
