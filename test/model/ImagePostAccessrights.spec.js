...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperOneApi.ImagePostAccessrights();
  });
  ...
  describe('ImagePostAccessrights', function() {
    it('should create an instance of ImagePostAccessrights', function() {
      ...
      //var instance = new HyperOneApi.ImagePostAccessrights();
      //expect(instance).to.be.a(HyperOneApi.ImagePostAccessrights);
    });
