...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new HyperoneClient.NetgwCreate();
  });
  ...
  describe('NetgwCreate', function() {
    it('should create an instance of NetgwCreate', function() {
      // uncomment below and update the code to test NetgwCreate
      //var instane = new HyperoneClient.NetgwCreate();
      //expect(instance).to.be.a(HyperoneClient.NetgwCreate);
    });
